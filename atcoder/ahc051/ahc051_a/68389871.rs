// Date: Sun, 10 Aug 2025 09:25:10 +0000
...
impl Graph {
    ...
    pub fn optimize_graph(&mut self, input: &Input) {
        ...
        let (mut current_score, _) = compute_score(&score_input, &current_output);
        ...
        while start_time.elapsed().as_secs_f64() < time_limit {
            ...
            // 新しい解のスコアを計算
            let (new_score, _) = compute_score(&score_input, &new_output);
        ...
        eprintln!("Optimization completed: {} iterations, best score: {}", iteration, best_score);
    }
