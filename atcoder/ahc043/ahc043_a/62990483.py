// Date: Sat, 22 Feb 2025 11:09:46 +0000
...
class Solver:
    ...
    def solve(self) -> Result:
        ...
        while person_idx < self.M:
            if select_dist < distance(self.home[person_idx], self.workplace[person_idx]) - 1 <= rail_count:
                select_dist = distance(self.home[person_idx], self.workplace[person_idx]) - 1
                select_person_idx = person_idx
            person_idx += 1
        assert select_person_idx != self.M
