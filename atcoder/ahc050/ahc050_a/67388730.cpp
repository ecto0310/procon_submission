// Date: Sun, 06 Jul 2025 12:41:32 +0000
...
vector<pair<ll, ll>> generate_hybrid_pattern(const Input& input) {
  ...
  for (ll turn = 0; turn < beam_start; ++turn) {
    double min_prob = 1.0;
  ...
  initial_state.S = S;
  initial_state.prob = prob;
  initial_state.positions = positions;
