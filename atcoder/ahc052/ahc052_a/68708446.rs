// Date: Sat, 23 Aug 2025 08:32:19 +0000
 ...
 impl Solver {
    ...
    fn solve_with_multiple_patterns(&mut self) -> Solution {
        ...
        for &pattern in &patterns {
            ...
            let solution = self.solve_with_pattern(pattern);
        ...
        best_solution.unwrap_or_else(|| self.solve_with_pattern(SearchPattern::TopLeft))
    }

    fn solve_with_pattern(&mut self, pattern: SearchPattern) -> Solution {
        ...
        // Phase 2: Generate action sequence with specific pattern
        self.generate_action_sequence_with_pattern(&mut solution, pattern);
    ...
    fn optimize_remaining_buttons(&self, solution: &mut Solution) {
        ...
        fn generate_action_sequence_with_pattern(&mut self, solution: &mut Solution, pattern: SearchPattern) {
        let mut visited = HashSet::new();
    ...
    fn generate_action_sequence(&mut self, solution: &mut Solution) {
        self.generate_action_sequence_with_pattern(solution, SearchPattern::TopLeft);
    }
    ...
    fn find_nearest_unvisited_cell(&self, visited: &HashSet<Position>) -> Option<Position> {
     ...
     fn find_button_for_robot_direction(&self, robot_id: usize, desired_direction: Direction, solution: &Solution) -> usize {
         ...
         panic!("find_button_for_robot_direction: 該当するボタンがない");
     }
